        ...
        <div class="row">
          ...
          <?php
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="submit_add_main_skills.php" method="POST">
                <div class="card-body"> 
                  ...
                  <input type="text" class="form-control" id="owner" placeholder="Enter owner skill" name="owner" 
                    value = "" >
                  </div>
